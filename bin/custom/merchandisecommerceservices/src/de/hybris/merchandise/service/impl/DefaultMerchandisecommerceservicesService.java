 ...
 */
package de.hybris.merchandise.service.impl;
...
public class DefaultMerchandisecommerceservicesService implements MerchandisecommerceservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMerchandisecommerceservicesService.class);
	...
	{
		return DefaultMerchandisecommerceservicesService.class.getResourceAsStream("/merchandisecommerceservices/sap-hybris-platform.png");
	}
